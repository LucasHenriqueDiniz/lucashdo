...
export const projects: Project[] = [
  {
    ...
    description: {
      'pt-BR':
        'Recriação do Windows XP com React em um servidor em tempo real para várias pessoas usarem simultaneamente.',
  ...
  },
  {
    ...
    description: {
      'pt-BR':
        'Criador cron de SVGs pegando informações de diferentes locais para criar SVGs e mostrar em perfis como GitHub para levar customização a um novo nível.',
  ...
  },
  {
    ...
    description: {
      'pt-BR':
        'Uma extensão para navegador projetada para melhorar a navegação no site Mannco Store. Nova versão das scripts Tampermonkey anteriores.',
  ...
  },
  {
    ...
    description: {
      'pt-BR':
        'Projeto descontinuado: extensão para navegador projetada para melhorar a navegação no site Mannco Store usando scripts Tampermonkey.',
  ...
  },
  {
    ...
    description: {
      'pt-BR':
        'Programa simples em Python para programar movimentos em intervalos de tempo em uma janela específica para farmar pontos de passe.',
  ...
  },
  {
    ...
    description: {
      'pt-BR':
        'Este projeto é um fork do backpack.tf-ws-service original, com foco em ser leve no MongoDB (para uso em tier gratuito) e com melhor estrutura de código e logging.',
  ...
  },
  {
    ...
    description: {
      'pt-BR':
        'Extensão para Skoob usando Tampermonkey para entrar automaticamente em sorteios de livros.',
  ...
  },
  {
    ...
    description: {
      'pt-BR':
        'Projeto de bolsa na faculdade: website completo para o projeto Include Gurias de inclusão de mulheres na programação, incluindo design no Figma e desenvolvimento completo.',
  ...
  },
  {
    ...
    description: {
      'pt-BR':
        'Extensão básica para pular o vídeo das recompensas diárias do site do Hypixel, usando Tampermonkey.',
  ...
  },
  {
    ...
    description: {
      'pt-BR':
        'Repositório para o Workshop Básico de Fullstack hospedado pela Engenharia do Futuro. Backend desenvolvido por Lucas Silva Ennes e frontend por Lucas Henrique Diniz Ostroski.',
